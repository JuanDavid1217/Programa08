...
public class EmpleadoController {
    ...
    @Autowired //implementa un praton singleton sobre el objeto de la instancia de la interface
   ...
   @GetMapping("/empleado/{id}")
    public DTOEmpleado obtenerEmpleado(@PathVariable("id") long id){
       ...
       return emp;*/
        ...
        //Empleado em=(Empleado)repositoryEmpleado.findById(id);
     ...
     public List<DTOEmpleado> obtenerTodosLosEmpleados(){
        ArrayList<Empleado> lista=(ArrayList<Empleado>) repositoryEmpleado.findAll();
        ArrayList<DTOEmpleado> list=new ArrayList<DTOEmpleado>();
    ...
    public DTOEmpleado saveEmpleado(@Validated @RequestBody DTOEmpleado emp) {
        ...
        Empleado pojoEmp = repositoryEmpleado.save(pojo);
